import svgPaths from "./svg-wclvbx8j6f";
...
function Container19() {
  return (
    <div className="h-[18px] opacity-50 relative shrink-0 w-[160px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] left-0 not-italic text-[#25282a] text-[12px] text-nowrap top-[0.5px]">Source Bin</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[160px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-start leading-[21px] not-italic relative size-full text-[14px] text-nowrap">
        ...
        <p className="relative shrink-0 text-[#020817]">Door 1</p>
      </div>
    </div>
  );
}
...
function Container21() {
  return (
    <div className="h-[21px] relative shrink-0 w-[34.031px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#020817] text-[14px] text-nowrap top-0">Bin A</p>
      </div>
    </div>
  );
}
...
function Container26() {
  return (
    <div className="h-[21px] relative shrink-0 w-[34.031px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#020817] text-[14px] text-nowrap top-0">10</p>
      </div>
    </div>
  );
}
...
function Restocked() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-end leading-[0] not-italic px-0 py-[8px] relative shrink-0 text-nowrap" data-name="Restocked">
      <div className="flex flex-col justify-center relative shrink-0 text-[#64748b] text-[16px]">
        <p className="leading-[normal] text-nowrap">Inventory (Vials)</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#25282a] text-[35px]">
        <p className="leading-[normal] text-nowrap">30</p>
      </div>
    </div>
  );
}
...
function Pencil() {
  return (
    <div className="absolute inset-[14.49%_14.46%_14.29%_14.45%]" data-name="pencil">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23 23">
        <g id="pencil">
          <path d={svgPaths.p34b0a800} fill="var(--fill-0, #095192)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function Pencil1() {
  return (
    <div className="overflow-clip relative shrink-0 size-[32px]" data-name="pencil">
      <Pencil />
    </div>
  );
}
...
function TargetVsScanned() {
  return (
    <div className="h-full relative shrink-0 w-[493px]" data-name="Target vs Scanned">
...
function Container32() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e5e7eb] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pb-[41px] pt-[40px] px-[24px] relative w-full">
          <div className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#020817] text-[14px] text-center text-nowrap">
            <p className="mb-0">Take the Qty to move out of this bin and</p>
            <p>click “Save” to proceed next</p>
          </div>
        </div>
      </div>
    </div>
...
function Ndc1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[0] not-italic relative shrink-0" data-name="NDC">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#64748b] text-[14px] text-nowrap">
        <p className="leading-[normal]">Source Bin</p>
      </div>
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center min-w-full relative shrink-0 text-[#095192] text-[0px] w-[min-content]">
