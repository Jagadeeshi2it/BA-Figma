import svgPaths from "./svg-3zhva7n9ii";
...
function Frame1410084043() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0">
      <Building1 />
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-end leading-[0] not-italic relative shrink-0 text-[#095192] text-[14px] text-left w-60">
        <p className="block leading-[18px] text-[12px]">
...
function Frame1410084044() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0">
      <MapMarker1 />
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-end leading-[0] not-italic relative shrink-0 text-[#095192] text-[14px] text-left w-[202px]">
        <p className="block leading-[18px] text-[12px] text-[13px]">
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0">
      ...
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#095192] text-[14px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre text-[12px] text-[13px]">
          Back office Station
        </p>
      </div>
    </div>
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[25px] items-center justify-start p-0 relative shrink-0">
      <div className="flex flex-col font-['Inter:Bold',_sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#25282a] text-[14px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">Chloe Test</p>
      </div>
...
export default function Frame1410084046({ onLogout }: { onLogout?: () => void }) {
  return (
