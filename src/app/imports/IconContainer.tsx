import svgPaths from "./svg-5vxb1bnmqw";
...
function Frame1410084041() {
  return (
    <div className="bg-[#ffffff] box-border content-stretch flex flex-col h-[50px] items-center justify-center p-0 relative shrink-0 w-full">
      <MenuItemIcon />
      <div
