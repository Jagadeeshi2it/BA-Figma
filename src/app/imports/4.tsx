import svgPaths from "./svg-g5fqpqo7j0";
...
function Container26() {
  return (
    <div className="h-[21px] relative shrink-0 w-[34.031px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#020817] text-[14px] text-nowrap top-0">4</p>
      </div>
    </div>
  );
}
...
function Trash() {
  return (
    <div className="absolute inset-[13.53%_13.54%_13.52%_13.54%]" data-name="trash">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="trash">
          <path d={svgPaths.pf2fe400} fill="var(--fill-0, #D9342B)" id="Vector" />
          <path d={svgPaths.p3b7d4d00} fill="var(--fill-0, #D9342B)" id="Vector_2" />
          <path d={svgPaths.p139f600} fill="var(--fill-0, #D9342B)" id="Vector_3" />
          <path d={svgPaths.p117fb780} fill="var(--fill-0, #D9342B)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function Trash1() {
  return (
    <div className="absolute left-[1130px] overflow-clip size-[20px] top-[calc(50%+0.5px)] translate-y-[-50%]" data-name="trash">
      <Trash />
    </div>
  );
}
...
function Container41() {
  return (
    <div className="absolute h-[21px] left-[64px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[-40px] not-italic text-[#25282a] text-[14px] text-nowrap top-0">25412179337595</p>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="absolute h-[21px] left-[266px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">9892297</p>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="absolute h-[21px] left-[468px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">Danaher Corporation</p>
    </div>
  );
}
...
function Container44() {
  return (
    <div className="absolute h-[21px] left-[670px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">06/02/2027</p>
    </div>
  );
}
...
function Container45() {
  return (
    <div className="absolute h-[21px] left-[872px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">1 vial / 400 mg / 16 ml</p>
    </div>
  );
}
...
function Container47() {
  return (
    <div className="bg-white content-stretch flex flex-col h-[54px] items-start pb-px pt-0 px-0 relative shrink-0 w-full" data-name="Container">
...
function Container48() {
  return (
    <div className="absolute h-[21px] left-[64px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[-40px] not-italic text-[#25282a] text-[14px] text-nowrap top-0">42007557201195</p>
    </div>
  );
}
...
function Container49() {
  return (
    <div className="absolute h-[21px] left-[266px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">7737896</p>
    </div>
  );
}
...
function Container50() {
  return (
    <div className="absolute h-[21px] left-[468px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">McKesson Medical</p>
    </div>
  );
}
...
function Container51() {
  return (
    <div className="absolute h-[21px] left-[670px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">07/24/2027</p>
    </div>
  );
}
...
function Container55() {
  return (
    <div className="absolute h-[21px] left-[64px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[-40px] not-italic text-[#25282a] text-[14px] text-nowrap top-0">47017060950493</p>
    </div>
  );
}
...
function Container56() {
  return (
    <div className="absolute h-[21px] left-[266px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">8972831</p>
    </div>
  );
}
...
function Container58() {
  return (
    <div className="absolute h-[21px] left-[670px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">08/18/2028</p>
    </div>
  );
}
...
function Container62() {
  return (
    <div className="absolute h-[21px] left-[64px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-[-40px] not-italic text-[#25282a] text-[14px] text-nowrap top-0">40611568719182</p>
    </div>
  );
}
...
function Container63() {
  return (
    <div className="absolute h-[21px] left-[266px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">1926429</p>
    </div>
  );
}
...
function Container65() {
  return (
    <div className="absolute h-[21px] left-[670px] top-[16px] w-[202px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[21px] left-0 not-italic text-[#25282a] text-[14px] text-nowrap top-0">04/09/2027</p>
    </div>
  );
}
...
function Serial() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px overflow-clip relative shrink-0 w-full" data-name="serial">
      <Container47 />
      <Container54 />
      <Container61 />
      <Container68 />
