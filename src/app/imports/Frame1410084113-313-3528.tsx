import svgPaths from "./svg-9crqj6fi1p";
...
function TargetVsScanned() {
  return (
    <div className="absolute box-border content-stretch flex gap-6 items-center justify-start px-6 py-0 right-px top-[209px]" data-name="Target vs Scanned">
      <Frame1 />
...
function SearchFrame() {
  return (
    <div className="absolute content-stretch flex h-12 items-start justify-start left-6 top-[228px] w-[386px]" data-name="SearchFrame">
      <Input />
      <InputGroupAddOns />
    </div>
  );
...
function Group1410083563() {
  return (
    <div className="absolute contents left-0 top-[202px]">
      <div className="absolute bg-[#e9eef4] h-px left-0 top-[202px] w-[1099px]" />
      <div className="absolute bg-[#e9eef4] h-px left-px top-[300px] w-[1099px]" />
      <TargetVsScanned />
      <SearchFrame />
    </div>
  );
...
function ColumnNames() {
  return (
    <div className="absolute bg-slate-50 left-6 rounded-tl-[4px] rounded-tr-[4px] top-[317px] w-[1052px]" data-name="Column Names">
...
function Frame1410084101() {
  return (
    <div className="absolute content-stretch flex flex-col items-start justify-start left-6 top-[357px] w-[1052px]">
      <TableRow />
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
...
function Group1410083562() {
  return (
    <div className="absolute contents left-6 top-[317px]">
      <ColumnNames />
      <Frame1410084101 />
    </div>
  );
...
function Container2() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-6 top-[57px] w-[1052px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Frame1410084124() {
  return (
    <div className="content-start flex flex-wrap font-['Inter:Regular',_sans-serif] font-normal gap-2 items-start justify-start leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap w-full">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[#020817]">
        <p className="leading-[normal] text-nowrap whitespace-pre">Purchased</p>
      </div>
    </div>
  );
}

function Frame1410084141() {
  return (
    <div className="content-stretch flex flex-col gap-2 items-start justify-start relative shrink-0 w-60">
      <div className="flex flex-col font-['Inter:Semi_Bold',_sans-serif] font-semibold h-[15px] justify-center leading-[0] not-italic opacity-50 relative shrink-0 text-[#25282a] text-[12px] w-full">
...
function Frame1410084125() {
  return (
    <div className="content-start flex flex-wrap font-['Inter:Regular',_sans-serif] font-normal gap-2 items-start justify-start leading-[0] not-italic relative shrink-0 text-[14px] text-nowrap w-full">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[#020817]">
        <p className="leading-[normal] text-nowrap whitespace-pre">Floor 1 (E-Kit)</p>
      </div>
    </div>
  );
}

function Frame1410084143() {
  return (
    <div className="content-stretch flex flex-col gap-2 items-start justify-start relative shrink-0 w-[200px]">
      <div className="flex flex-col font-['Inter:Semi_Bold',_sans-serif] font-semibold h-[15px] justify-center leading-[0] not-italic opacity-50 relative shrink-0 text-[#25282a] text-[12px] w-full">
        <p className="leading-[normal]">Allocation Details</p>
      </div>
      <Frame1410084122 />
      <Frame1410084125 />
    </div>
...
function Frame1410084144() {
  return (
    <div className="absolute bg-[#e9eef4] box-border content-stretch flex gap-[60px] h-[89px] items-center justify-start left-0 px-6 py-3 top-[113px] w-[1100px]">
      <Frame1410084141 />
      <Frame1410084142 />
      <Frame1410084143 />
    </div>
...
function Frame1410084132() {
  return (
    <div className="content-stretch flex flex-col gap-1 items-start justify-start relative shrink-0 w-[632px]">
      <div className="flex flex-col font-['Inter:Regular',_sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[21px] text-neutral-950 w-full">
...
function Frame1410084133() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-6 top-4 w-[1052px]">
      <Frame1410084132 />
      <Group1410083566 />
    </div>
  );
