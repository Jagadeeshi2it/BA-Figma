function Frame1410084217() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic relative shrink-0 text-nowrap whitespace-pre">
      ...
      <p className="font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#165dfc] text-[12px]">Selected: 5 bins</p>
    </div>
  );
}

function Frame1410084219() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic relative shrink-0 text-nowrap whitespace-pre">
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-black tracking-[-0.1504px]">Step 2. Select one or more target bins</p>
      <p className="font-['Inter:Semi_Bold',_sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#00a73d] text-[12px]">Selected: 8 bins</p>
    </div>
  );
}

function Frame1410084220() {
  return (
    <div className="content-stretch flex gap-[60px] items-center relative shrink-0 w-[729.5px]">
      <Frame1410084217 />
      <Frame1410084219 />
    </div>
  );
...
function Container1() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[10px] items-center justify-center px-[11px] py-[7px] relative rounded-[4px] shrink-0" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#095192] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <p className="capitalize font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#095192] text-[14px] text-nowrap whitespace-pre">Back</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="bg-[#095192] box-border content-stretch flex gap-[10px] items-center justify-center px-[11px] py-[7px] relative rounded-[4px] shrink-0" data-name="Container">
      <p className="capitalize font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Confirm Selection</p>
    </div>
  );
}
